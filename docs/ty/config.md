[Skip to content](https://docs.astral.sh/ty/configuration/#configuration)

# [Configuration](https://docs.astral.sh/ty/configuration/\#configuration)

## [Configuration files](https://docs.astral.sh/ty/configuration/\#configuration-files)
...
See the [configuration](https://docs.astral.sh/ty/reference/configuration/) reference for an enumeration of the available settings.
