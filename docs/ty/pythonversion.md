[Skip to content](https://docs.astral.sh/ty/python-version/#python-version)

# [Python version](https://docs.astral.sh/ty/python-version/\#python-version)
...
If the `requires-python` field is not available but a virtual environment _has_ been
...
[`python-version`](https://docs.astral.sh/ty/reference/configuration/#python-version) setting or the
[`--python-version`](https://docs.astral.sh/ty/reference/cli/#ty-check--python-version) flag.
