...
This example shows how to parse a JSON input where the quotes have been
...
# --- Lark Grammar (preserved exactly) ---
GRAMMAR = r"""
...
# --- Transformer to pick the highest-scoring parse for ambiguities ---
...
# --- Transformer from parse tree to Python data (same as json_parser example) ---
...
# --- Parser configured for Earley + dynamic_complete with explicit ambiguities ---
