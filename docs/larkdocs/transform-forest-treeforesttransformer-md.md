---
title: Transform a Forest (TreeForestTransformer example)
description: Demonstrates subclassing TreeForestTransformer to directly transform an Earley SPPF forest into a tree while handling ambiguity.
...
This example demonstrates how to subclass TreeForestTransformer to directly transform an SPPF (shared packed parse forest) and handle ambiguity.
