---
title: Lark Simple JSON Parser (Python)
description: A concise, efficient JSON parser implemented with Lark's grammar and a Transformer, including both Earley and LALR configurations.
