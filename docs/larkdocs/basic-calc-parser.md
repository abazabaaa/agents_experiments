...
description: A simple REPL calculator with variables using Lark's LALR parser and Transformer.
source_url: https://lark-parser.readthedocs.io/en/stable/_downloads/50b59008a60a728670b293084a6fe042/calc.py
---

# Basic calculator

A simple REPL calculator that supports variables, implemented with Lark.
