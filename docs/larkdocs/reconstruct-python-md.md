...
This example demonstrates how Lark’s experimental text-reconstruction feature can recreate functional Python code from a parse tree using the official Python grammar and a small formatter.
