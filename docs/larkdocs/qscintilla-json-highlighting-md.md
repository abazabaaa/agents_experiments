---
title: QScintilla Syntax Highlighting with Lark (PyQt5)
description: Example of building a syntax-highlighted editor using PyQt5, QScintilla, and Lark. Includes a minimal lexer and a JSON-like token grammar.
source_url: https://lark-parser.readthedocs.io/en/stable/_downloads/1e229dcdb521be752d4349e61ead59d1/qscintilla_json.py
---

# Syntax Highlighting with QScintilla and Lark
