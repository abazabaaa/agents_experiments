...
description: "Example Python 2 & 3 parser using Lark grammars. Demonstrates loading bundled and local grammars and includes tests that parse the standard library files."
source_url: "embedded"
---

# Grammar-complete Python Parser

A fully-working Python 2 & 3 parser (example). This file demonstrates usage of the included Python grammars with Lark and includes simple tests that parse files from the Python standard library.
...
This document contains a Python script that demonstrates using Lark to parse Python 2 and 3 code. It loads the bundled Python 3 grammar and a local Python 2 grammar, selects the appropriate parser at runtime, and includes tests that parse files from the standard library to exercise the grammars.
