...
description: "Example showing how Lark's experimental text-reconstruction can rebuild Python source from a parse-tree using Lark's grammar and a small formatter."
source_url: "https://github.com/lark-parser/lark/blob/master/examples/reconstruct_python.py"
---
...
This example shows how to use Lark's Reconstructor together with the
Python indenter to reconstruct Python source code from a parse-tree.
