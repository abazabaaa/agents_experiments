---
title: "Reconstruct a JSON (Reconstructor example)"
description: "Python script demonstrating Lark's Reconstructor to reconstruct JSON from parse trees."
source_url: "original_source_not_provided"
---
