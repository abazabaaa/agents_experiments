...
description: "A script demonstrating translation from Python 3 AST to Python 2 using tree templates and Lark."
source_url: "user_submission"
---

# Python 3 to Python 2 converter (tree templates)

Processed script (no fenced code block). The original Python script content is preserved exactly below for downstream review.
...
Summary: YAML front-matter added; original script preserved verbatim below header. No code changes.