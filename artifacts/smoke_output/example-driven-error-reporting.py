...
description: A demonstration of example-driven error reporting with the LALR parser in Lark. Includes a sample Python script that maps parsing errors to custom exceptions using example-driven matching.
source_url: https://github.com/lark-parser/lark/blob/acfe33d943a1310f3ca26145eb2896bc5c4955c9/docs/examples/advanced/error_reporting_lalr.rst
---
...
- Example-Driven Error Reporting (this page)
...
- Versions: [latest](https://lark-parser.readthedocs.io/en/latest/examples/advanced/error_reporting_lalr.html), [stable](https://lark-parser.readthedocs.io/en/stable/examples/advanced/error_reporting_lalr.html)
...
- On Read the Docs: [Project Home](https://app.readthedocs.org/projects/lark-parser/?utm_source=lark-parser&utm_content=flyout), [Builds](https://app.readthedocs.org/projects/lark-parser/builds/?utm_source=lark-parser&utm_content=flyout)
...
- Removed extraneous navigation UI artifacts and duplicate navigation links while preserving technical cross-references.
- Normalized heading structure and link formatting.
- Fixed escaped underscores and removed spurious backslashes in plain-text URLs and references (e.g., error_reporting_earley.py and internal anchors).
- Preserved the Python code block exactly; collapsed any redundant backslash sequences in code strings where they originated from HTML escaping.
- Kept all download links and the original source reference.
