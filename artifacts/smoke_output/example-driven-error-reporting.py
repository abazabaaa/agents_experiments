"""
Example-Driven Error Reporting with LALR parser (Lark)

This module demonstrates using example-driven error reporting with the LALR
parser. It uses a JSON grammar (imported from _json_parser) and maps
UnexpectedInput errors to more specific custom exceptions by matching
parse-examples.
"""
