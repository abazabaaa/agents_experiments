...
description: "Example demonstrating how to subclass ForestVisitor to create a custom SPPF node prioritizer used with TreeForestTransformer."
source_url: "https://github.com/lark-parser/lark/blob/master/examples/custom_sppf_prioritizer.py"
---
