...
description: Demonstrates translating Python 3 parse trees to Python 2 using Lark tree templates and reconstructing valid Python 2 code.
...
This example demonstrates how to translate between two trees using tree templates. It parses Python 3, translates it to a Python 2 AST, and then outputs the result as Python 2 code. It uses reconstruct_python.py to generate the final Python 2 code.
