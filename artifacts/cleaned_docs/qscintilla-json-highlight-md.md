---
title: Syntax Highlighting (QScintilla + Lark)
description: Example showing how to build a syntax-highlighted editor using PyQt5/QScintilla and a Lark lexer.
