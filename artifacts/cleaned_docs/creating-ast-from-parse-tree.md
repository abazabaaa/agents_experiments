...
description: Demonstrates transforming a Lark parse tree into a typed AST using ast_utils.create_transformer and a custom Transformer for leaf conversions.
