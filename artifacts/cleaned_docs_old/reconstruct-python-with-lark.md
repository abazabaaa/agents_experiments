---
title: Reconstruct Python with Lark
summary: Demonstrates using Lark's experimental text-reconstruction to recreate runnable Python code from its parse tree using the official Python grammar and a small formatter.
source_url: https://lark-parser.readthedocs.io/en/stable/_downloads/3b0766c1f76ff2904339853615cf4943/reconstruct_python.py
---

# Reconstruct Python

This example demonstrates how Lark's experimental text-reconstruction feature can recreate functional Python code from its parse tree, using the official Python grammar and a small formatter.
