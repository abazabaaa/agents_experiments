---
title: Example-Driven Error Reporting (Earley)
...
description: Demonstration of example-driven error reporting for Lark's Earley parser, using the JSON grammar example.
---
