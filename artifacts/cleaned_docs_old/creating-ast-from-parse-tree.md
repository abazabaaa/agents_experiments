---
title: Creating an AST from the parse tree (Lark)
description: Demonstrates transforming a Lark parse tree into a typed AST using lark.ast_utils, including custom transformer hooks and metadata.
source_url: https://lark-parser.readthedocs.io/en/stable/_downloads/bfeb22cff3ae6c24841aad8c5a95d047/create_ast.py
language: python
audience: developers
tags: [lark, parsing, ast, python]
---
...
create_transformer() collects every subclass of Ast from the module and creates a Lark transformer that builds the AST with minimal extra code.

Note: This example only works with Python 3.
