...
description: Demonstrates translating Python 3 syntax to Python 2 using Lark tree templates and reconstructing code with PythonReconstructor.
...
It uses `reconstruct_python.py` for generating the final Python 2 code.
